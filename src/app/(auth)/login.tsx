...
export default function Login() {
  ...
  return (
    <View className="flex-1 justify-center px-6 bg-white dark:bg-black">
      <Text className="text-2xl font-bold mb-4 text-center text-black dark:text-white">Welcome Back</Text>
      ...
      <TouchableOpacity onPress={() => router.replace('/signup')}>
        <Text className="text-center text-gray-500 mt-2">Don’t have an account? <Text className="text-indigo-600">Sign Up</Text></Text>
      </TouchableOpacity>
    </View>
  )
}
